...
OUTPUT=build/flattened/DSDOracleHelper.flattened.sol
...
yarn --silent truffle-flattener contracts/dsd/DSDOracleHelper.sol | awk '!/SPDX-License-Identifier/' | awk '/pragma experimental ABIEncoderV2;/&&c++>0 {next} 1' >> "$OUTPUT"